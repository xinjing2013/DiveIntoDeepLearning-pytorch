...
https://www.boyuai.com/elites/course/cZu18YmweLv10OeV/jupyter/wsciGtdSxatryq6J3N4VQ

https://www.kesci.com/org/boyuai/project/5e4ba1d180da780037bdd0c1
...
![img](https://staticcdn.boyuai.com/rt_upload/C9CAC60A6ADF4814AA1EFBB838B80254/q5vrftusng.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/D3875332DE3140BA88D963B12739617F/q5vrg7oclo.svg)
...
我们看到，返回锚框变量`y`的形状为（1，锚框个数，4）。将锚框变量`y`的形状变为（图像高，图像宽，以相同像素为中心的锚框个数，4）后，我们就可以通过指定像素位置来获取所有以该像素为中心的锚框了。下面的例子里我们访问以（250，250）为中心的第一个锚框。它有4个元素，分别是锚框左上角的*x*和*y*轴坐标和右下角的*x*和*y*轴坐标，其中*x*和*y*

轴的坐标值分别已除以图像的宽和高，因此值域均为0和1之间。
...
![img](https://staticcdn.boyuai.com/rt_upload/28FFDB57F6CB43A69163325A4D136A48/q5vrnk8tho.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/EE440F7DF1044779979C9EE9F4906CDC/q5vscwrldv.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/9A3523CA158741A9BE840976BD280FCD/q5vse9q5nx.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/20C0E67E283D4D4BBF20B9E2A4F46915/q5vsen38ta.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/FFD6EFB60BAC460A83015115A93376B0/q5vsflnl9m.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/B4223FD7BD5D4320B1FDB53445264F79/q5vsfnl3b0.svg)
...
![img](https://staticcdn.boyuai.com/rt_upload/1A763C2BB5BA404092B31C190A963A17/q5vsfq54gp.svg)
